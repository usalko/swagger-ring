...
type RefNameResolver func(*Document, ComponentRef) string
...
func DefaultRefNameResolver(doc *Document, ref ComponentRef) string {
...
func (doc *Document) addSchemaToSpec(s *SchemaRef, refNameResolver RefNameResolver, parentIsExternal bool) bool {
...
func (doc *Document) addParameterToSpec(p *ParameterRef, refNameResolver RefNameResolver, parentIsExternal bool) bool {
...
func (doc *Document) addHeaderToSpec(h *HeaderRef, refNameResolver RefNameResolver, parentIsExternal bool) bool {
...
func (doc *Document) addRequestBodyToSpec(r *RequestBodyRef, refNameResolver RefNameResolver, parentIsExternal bool) bool {
...
func (doc *Document) addResponseToSpec(r *ResponseRef, refNameResolver RefNameResolver, parentIsExternal bool) bool {
	if r == nil || !isExternalRef(r.Ref, parentIsExternal) {
		return false
	}
	name := refNameResolver(doc, r)
...
func (doc *Document) addSecuritySchemeToSpec(ss *SecuritySchemeRef, refNameResolver RefNameResolver, parentIsExternal bool) {
...
func (doc *Document) addExampleToSpec(e *ExampleRef, refNameResolver RefNameResolver, parentIsExternal bool) {
...
func (doc *Document) addLinkToSpec(l *LinkRef, refNameResolver RefNameResolver, parentIsExternal bool) {
...
func (doc *Document) addCallbackToSpec(c *CallbackRef, refNameResolver RefNameResolver, parentIsExternal bool) bool {
...
func (doc *Document) derefSchema(s *Schema, refNameResolver RefNameResolver, parentIsExternal bool) {
...
func (doc *Document) derefHeaders(hs Headers, refNameResolver RefNameResolver, parentIsExternal bool) {
...
func (doc *Document) derefExamples(es Examples, refNameResolver RefNameResolver, parentIsExternal bool) {
...
func (doc *Document) derefContent(c Content, refNameResolver RefNameResolver, parentIsExternal bool) {
...
func (doc *Document) derefLinks(ls Links, refNameResolver RefNameResolver, parentIsExternal bool) {
...
func (doc *Document) derefResponse(r *ResponseRef, refNameResolver RefNameResolver, parentIsExternal bool) {
...
func (doc *Document) derefResponses(rs *Responses, refNameResolver RefNameResolver, parentIsExternal bool) {
	doc.derefResponseBodies(rs.Map(), refNameResolver, parentIsExternal)
}

func (doc *Document) derefResponseBodies(es ResponseBodies, refNameResolver RefNameResolver, parentIsExternal bool) {
	for _, name := range componentNames(es) {
		e := es[name]
...
func (doc *Document) derefParameter(p Parameter, refNameResolver RefNameResolver, parentIsExternal bool) {
...
func (doc *Document) derefRequestBody(r RequestBody, refNameResolver RefNameResolver, parentIsExternal bool) {
	doc.derefContent(r.Content, refNameResolver, parentIsExternal)
}

func (doc *Document) derefPaths(paths map[string]*PathItem, refNameResolver RefNameResolver, parentIsExternal bool) {
...
func (doc *Document) InternalizeRefs(ctx context.Context, refNameResolver func(*Document, ComponentRef) string) {
	doc.resetVisited()
