...
func (requestBody *RequestBody) UnmarshalJSON(data []byte) error {
	// type RequestBodyBis RequestBody // usalko:patch
	var x RequestBody
...
func (requestBodies *RequestBodies) UnmarshalJSON(data []byte) (err error) {
	// *requestBodies, _, err = unmarshalStringMapP[RequestBodyRef](data) // usalko:patch
	*requestBodies, _, err = unmarshalStringMapPRequestBodyRef(data)
	return
}
