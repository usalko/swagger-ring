...
func (ss *SecurityScheme) UnmarshalJSON(data []byte) error {
	// type SecuritySchemeBis SecurityScheme // usalko:pathc
	var x SecurityScheme
...
func (flows *OAuthFlows) UnmarshalJSON(data []byte) error {
	// type OAuthFlowsBis OAuthFlows // usalko:pathc
	var x OAuthFlows
	if err := json.Unmarshal(data, &x); err != nil {
		return unmarshalError(err)
	}
...
func (flow *OAuthFlow) UnmarshalJSON(data []byte) error {
	// type OAuthFlowBis OAuthFlow // usalko:pathc
	var x OAuthFlow
	if err := json.Unmarshal(data, &x); err != nil {
		return unmarshalError(err)
	}
...
func (securitySchemes *SecuritySchemes) UnmarshalJSON(data []byte) (err error) {
	// *securitySchemes, _, err = unmarshalStringMapP[SecuritySchemeRef](data) // usalko:patch
	*securitySchemes, _, err = unmarshalStringMapPSecuritySchemeRef(data)
	return
}
