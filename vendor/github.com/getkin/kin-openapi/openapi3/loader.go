...
type Loader struct {
	...
	visitedDocuments map[string]*Document
...
func (loader *Loader) LoadFromURI(location *url.URL) (*Document, error) {
...
func (loader *Loader) LoadFromFile(location string) (*Document, error) {
	loader.rootDir = path.Dir(location)
	return loader.LoadFromURI(&url.URL{Path: filepath.ToSlash(location)})
}

func (loader *Loader) loadFromURIInternal(location *url.URL) (*Document, error) {
...
func (loader *Loader) LoadFromStdin() (*Document, error) {
	return loader.LoadFromIoReader(os.Stdin)
}

// LoadFromStdin loads a spec from io.Reader
func (loader *Loader) LoadFromIoReader(reader io.Reader) (*Document, error) {
	if reader == nil {
...
func (loader *Loader) LoadFromData(data []byte) (*Document, error) {
	loader.resetVisitedPathItemRefs()
	doc := &Document{}
...
func (loader *Loader) LoadFromDataWithPath(data []byte, location *url.URL) (*Document, error) {
	loader.resetVisitedPathItemRefs()
	return loader.loadFromDataWithPathInternal(data, location)
}

func (loader *Loader) loadFromDataWithPathInternal(data []byte, location *url.URL) (*Document, error) {
	if loader.visitedDocuments == nil {
		loader.visitedDocuments = make(map[string]*Document)
...
func (loader *Loader) ResolveRefsIn(doc *Document, location *url.URL) (err error) {
...
func (loader *Loader) resolveComponent(doc *Document, ref string, path *url.URL, resolved any) (
	componentDoc *Document,
...
func (loader *Loader) resolveRefAndDocument(doc *Document, ref string, path *url.URL) (*Document, string, *url.URL, error) {
	if ref != "" && ref[0] == '#' {
...
func (loader *Loader) resolveHeaderRef(doc *Document, component *HeaderRef, documentPath *url.URL) (err error) {
...
func (loader *Loader) resolveParameterRef(doc *Document, component *ParameterRef, documentPath *url.URL) (err error) {
	if component.isEmpty() {
...
func (loader *Loader) resolveRequestBodyRef(doc *Document, component *RequestBodyRef, documentPath *url.URL) (err error) {
	if component.isEmpty() {
...
func (loader *Loader) resolveResponseRef(doc *Document, component *ResponseRef, documentPath *url.URL) (err error) {
	if component.isEmpty() {
...
func (loader *Loader) resolveSchemaRef(doc *Document, component *SchemaRef, documentPath *url.URL, visited []string) (err error) {
	if component.isEmpty() {
...
func (loader *Loader) resolveSecuritySchemeRef(doc *Document, component *SecuritySchemeRef, documentPath *url.URL) (err error) {
	if component.isEmpty() {
...
func (loader *Loader) resolveExampleRef(doc *Document, component *ExampleRef, documentPath *url.URL) (err error) {
	if ref := component.Ref; ref != "" {
		if component.Value != nil {
			return nil
		}
...
func (loader *Loader) resolveCallbackRef(doc *Document, component *CallbackRef, documentPath *url.URL) (err error) {
	if component.isEmpty() {
...
func (loader *Loader) resolveLinkRef(doc *Document, component *LinkRef, documentPath *url.URL) (err error) {
	if component.isEmpty() {
		return errMUSTLink
	}
...
func (loader *Loader) resolvePathItemRef(doc *Document, pathItem *PathItem, documentPath *url.URL) (err error) {
	if pathItem == nil {
		err = errMUSTPathItem
		return
	}
