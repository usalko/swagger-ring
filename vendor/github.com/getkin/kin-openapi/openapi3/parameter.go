...
func (parameter *Parameter) UnmarshalJSON(data []byte) error {
	// type ParameterBis Parameter // usalko:patch
	var x Parameter
...
func (parametersMap *ParametersMap) UnmarshalJSON(data []byte) (err error) {
	// *parametersMap, _, err = unmarshalStringMapP[ParameterRef](data) // usalko:patch
	*parametersMap, _, err = unmarshalStringMapPParameterRef(data)
	return
}
