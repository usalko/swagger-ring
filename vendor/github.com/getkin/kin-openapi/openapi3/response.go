...
func (response *Response) UnmarshalJSON(data []byte) error {
	// type ResponseBis Response // usalko:patch
	var x Response
...
func (responseBodies *ResponseBodies) UnmarshalJSON(data []byte) (err error) {
	// *responseBodies, _, err = unmarshalStringMapP[ResponseRef](data) // usalko:patch
	*responseBodies, _, err = unmarshalStringMapPResponseRef(data)
	return
}
